...
| [`OPERATIONS.md`](./OPERATIONS.md) | **唯一的运维现状**：现状速览、台账状态（N 任务 / Q 疑点）、已知限制与风险 | 重复 [`SPEC.md`](./SPEC.md) 的规格台账 |
| [`SPEC.md`](./SPEC.md) | **唯一的规格台账**：条目状态、质量门禁、**决策记录 D1–D18（唯一定义处）** | 文档规则、部署现状、运维待办 |
| **本文** | 文档规则与职责划分、脱敏说明 | 条目状态、决策记录、部署现状、运维待办 |
